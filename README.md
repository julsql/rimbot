...
Générateur de poèmes français aléatoires. Réécriture moderne du projet Django original
en monorepo : **API Flask** + **base PostgreSQL** seedée + **front React (Vite)**, le
tout dockerisé et testé en CI.

> Site historique : [poeme.julsql.fr](http://poeme.julsql.fr)
