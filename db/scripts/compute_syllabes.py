...
EXTRA_DICT = {
    ...
    "fluffy": 2, "graceful": 2,
    # Personnages littéraires/historiques
    "werther": 2, "bovary": 3, "cyrano": 3, "esmeralda": 4,
    "carmen": 2, "frollo": 2,
    # Régions et lieux français
    "loire": 1, "beauce": 1, "brocéliande": 4, "finistère": 3,
    "languedoc": 3, "marseille": 2, "périgord": 3, "rouergue": 2,
    "vercors": 2, "vincennes": 2, "volvic": 2,
    # Pierres et matériaux
    "calcédoine": 4, "pumice": 2, "péridot": 3, "tourmaline": 3,
    # Divers
    "vingts": 1,
}
